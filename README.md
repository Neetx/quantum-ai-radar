...
- [Quantum-advantage frontier](TRENDS.md#id-trend-011-quantum-advantage-frontier-provable-learning-separations-and-honest-quantum-classical-crossovers) revived dormant → accelerating on a fresh [unconditional two-round CHSH advantage result](https://arxiv.org/abs/2609.21237).
- [Practical QEC tooling](TRENDS.md#id-trend-001-practical-qec-tooling-near-term-error-detection-and-the-path-to-ftqc) cap-swapped in NVIDIA/Microsoft's [CUDA-Q Logical retargetable compiler](https://arxiv.org/abs/2609.13388), resolving an 11-day-standing flagged candidate.
- [Quantum transformers and attention](TRENDS.md#id-trend-016-quantum-transformers-and-attention-pqc-based-attention-mechanisms-for-sequence-and-signal-processing) and [AI-for-quantum (circuit synthesis)](TRENDS.md#id-trend-012-ai-for-quantum-circuit-synthesis-leg-generativetransformer-models-that-directly-synthesize-quantum-circuits) each gained a fresh independent group — a [Hilbert-space interpretability paper](https://arxiv.org/abs/2609.23016) and a [quantum-augmented diffusion language model](https://arxiv.org/abs/2609.24657).
- Observation queue: 4 additions, 0 drops, net up to 27 (a touch over the ~25 cap).
...
| [AI-for-quantum (circuit synthesis)](TRENDS.md#id-trend-012-ai-for-quantum-circuit-synthesis-leg-generativetransformer-models-that-directly-synthesize-quantum-circuits) | 📈 emerging | [2026-09-21](https://arxiv.org/abs/2609.24657) |
...
- r/QuantumComputing carried only a routine, already-tracked hardware post this run — no fresh technical signal.
- Hacker News's front page and quantum-tagged search surfaced funding/M&A announcements and a notable quantum-architecture position paper, now queued alongside this radar's own evidence on the same authors.
- Digest coverage (Quantum Computing Report, Quantum Insider, Quantum Zeitgeist) was dominated by routine partnership/personnel/funding items this run, with no new technical primary beyond what the primary sweep already found.
- No new untracked publishing domain surfaced this run; yesterday's staged vendor candidate did not recur.

---

**Output map:** [TRENDS.md](TRENDS.md) · [watchlist (27)](TRENDS.md#observation_queue) · [reports/](reports/) · daily: [2026-09-22](reports/2026-09-22.md) · weekly: [2026-W38](reports/weekly/2026-W38.md) · [AGENTS.md](AGENTS.md) · [SOURCES.md](SOURCES.md)
