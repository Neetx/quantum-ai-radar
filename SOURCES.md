...
- eprint.iacr.org (IACR Cryptology ePrint Archive) — times seen 1 — "A Polynomial-Time Quantum Algorithm for the Dihedral Coset Problem" (2026/1591, Daniel R. Simon) — first seen 2026-08-06 (published-venue domain for quantum-algorithms/cryptanalysis primaries; discovered via HN front-page, an already-tracked community-pulse channel; `tvly extract` returns nav-only on this domain, plain `curl` gets the full abstract/metadata — record that method if this recurs)
