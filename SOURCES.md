...
- iopscience.org (IOP Publishing — Quantum Science and Technology journal) — times seen 1 — "Quantum Adaptive Self-Attention for quantum Transformer models" (QASA), Quantum Sci. Technol. 11(3), DOI 10.1088/2058-9565/ae8b21, published 2026-07-29 — first seen 2026-08-05 (published-venue domain; discovered via a tracked Quantum Zeitgeist digest pointer; iopscience.org itself returned only a cookie-consent wall to `tvly extract`, publication metadata confirmed via Crossref API instead)
