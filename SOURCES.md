...
- eprint.iacr.org (IACR Cryptology ePrint Archive) — times seen 2 — "The ePrint:2026/1591 Quantum Algorithm Does Not Solve DCP" (2026/1693, Gupte/Ragavan/Zhandry) — last seen 2026-08-18 (published-venue domain for quantum-algorithms/cryptanalysis primaries; first seen 2026-08-06 via HN, this 2nd appearance found via a Tavily web search while re-checking the standing watch item, not a swept digest — meets the ≥2-run recurrence promotion bar; `tvly extract` still returns nav-only on this domain, `tvly extract --extract-depth advanced` on the specific `/YYYY/NNNN` paper page DOES return the abstract/metadata cleanly — flag for W-weekly promotion decision to a verified swept research venue)
