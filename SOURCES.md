...
- nature.com — main **Nature** journal (s41586-*) — times seen: 2 — last on-axis artifact: Quantinuum/Harvard/UChicago/Stony Brook "Universal topological gates via braiding+fusing S3 anyons on H2" (arXiv:2601.20956, published in Nature; surfaced via QC Report digest 2026-07-18) [prev: Google RL-QEC s41586-026-10759-2, 2026-07-08] — first seen 2026-07-16. CAVEAT (mirrors the ncomms case dropped 2026-07-11): main Nature is a multidisciplinary firehose with negligible quantum density and no subject filter on the plain RSS — BUT it is where FLAGSHIP quantum lands (Google Willow, Quantum Echoes, and now RL-QEC land in Nature, not npjqi). Weekly to decide whether a filtered `nature.com/subjects/quantum-information` view is sweepable; otherwise keep relying on the tracked digests (TQI/QC Report) to surface its rare on-axis papers. Discovery surface this run = The Quantum Insider (tracked).
