...
- iopscience.org (IOP Publishing — Quantum Science and Technology journal) — times seen 2 — "Integrability of Goldilocks quantum cellular automata", DOI 10.1088/2058-9565/ae57d5, published 2026-06 — 2nd seen 2026-08-12 (discovered via Quantum Frontiers' personal-essay blog post, a tracked independent-voice source but a NON-digest path — meets the W32-proposed 2nd-appearance promotion condition; first appearance: "Quantum Adaptive Self-Attention for quantum Transformer models" (QASA), Quantum Sci. Technol. 11(3), DOI 10.1088/2058-9565/ae8b21, published 2026-07-29 — first seen 2026-08-05, discovered via a tracked Quantum Zeitgeist digest pointer; iopscience.org itself returns only a cookie-consent wall to `tvly extract`, publication metadata confirmed via Crossref API instead both times) — FLAGGED for W33 promotion per the standing W32 proposal
