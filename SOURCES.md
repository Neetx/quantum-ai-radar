...
- quantum-machines.co (Quantum Machines) — times seen 1 — RL-agent two-qubit CZ-gate calibration with Academia Sinica, cutting calibration from ~15min to ~25s (reported Aug-30) — first seen 2026-08-31 (on-axis AI-for-quantum-hardware vendor; discovered via a Quantum Zeitgeist digest pointer, the vendor's own blog 403'd this session — re-attempt direct fetch next run)
